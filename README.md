...
### Pclass ###                         |  ### Sex ###
:-------------------------------------:|:----------------------------------------------------:
High percentage of Third Class passengers | It appears that males had a lower chance of survival compared to females.
perished, while First Class was the only |
category to have a higher percentage of | 
