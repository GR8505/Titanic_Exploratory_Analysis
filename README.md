...
| Pclass                                  | Sex                                        |
|-----------------------------------------|--------------------------------------------|
|High percentage of Third Class passengers| It appears that males had a lower chance of| 
|perished, while First Class was the only | survival compared to females.              |
